...
(() => {
  ...
  // src/index.ts
  // vendored locally (design/vendor/) to drop the unpkg CDN dependency — works offline.
  // SRI dropped: same-origin file we control; the integrity hash would only risk false mismatches.
